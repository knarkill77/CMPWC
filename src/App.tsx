...
function App() {
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans">
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-[60] focus:bg-wrestling-red focus:text-white focus:px-4 focus:py-2 focus:font-bold focus:outline-none focus:ring-2 focus:ring-white"
      >
        Skip to content
      </a>
      ...
      <nav className="fixed w-full z-50 bg-black/90 backdrop-blur-sm border-b border-white/10">
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-8">
                ...
                <a href="#teams" className="hover:text-wrestling-red px-3 py-2 text-sm font-medium uppercase transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-wrestling-red">Teams</a>
                <a href="#schedule" className="hover:text-wrestling-red px-3 py-2 text-sm font-medium uppercase transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-wrestling-red">Schedule</a>
                <a href="#details" className="hover:text-wrestling-red px-3 py-2 text-sm font-medium uppercase transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-wrestling-red">Details</a>
              </div>
            </div>
        ...
        {/* Mobile menu */}
        {isMenuOpen && (
          <div id="mobile-menu" className="md:hidden bg-black border-b border-white/10">
      ...
      <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden pt-16">
        ...
        <div id="main-content" className="relative z-20 text-center px-4 max-w-4xl outline-none" tabIndex={-1}>
