                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="text-wrestling-silver hover:text-wrestling-red transition underline-offset-4 hover:underline"
                    >
                      {siteContent.contact.name} - {siteContent.contact.email}
                    </a>
                  </div>
                </div>
              </div>
