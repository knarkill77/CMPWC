...
function App() {
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans">
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:fixed focus:z-[60] focus:top-4 focus:left-4 focus:bg-wrestling-red focus:text-white focus:px-4 focus:py-2 focus:font-bold focus:outline-none focus:ring-2 focus:ring-white"
      >
        Skip to content
      </a>
