...
function App() {
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans">
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:fixed focus:z-[100] focus:top-4 focus:left-4 focus:bg-wrestling-red focus:text-white focus:px-4 focus:py-2 focus:font-bold focus:outline-none focus:ring-2 focus:ring-white"
      >
        Skip to content
      </a>
      ...
      <nav
        ...
        className="fixed w-full z-50 bg-black/90 backdrop-blur-sm border-b border-white/10"
      >
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="md:hidden">
              <button
                ...
                className="p-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-wrestling-red rounded-md"
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-black border-b border-white/10">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              <a href="#home" onClick={() => setIsMenuOpen(false)} className="block px-3 py-2 text-base font-medium uppercase hover:text-wrestling-red transition">Home</a>
              <a href="#teams" onClick={() => setIsMenuOpen(false)} className="block px-3 py-2 text-base font-medium uppercase hover:text-wrestling-red transition">Teams</a>
              <a href="#schedule" onClick={() => setIsMenuOpen(false)} className="block px-3 py-2 text-base font-medium uppercase hover:text-wrestling-red transition">Schedule</a>
              <a href="#details" onClick={() => setIsMenuOpen(false)} className="block px-3 py-2 text-base font-medium uppercase hover:text-wrestling-red transition">Details</a>
            </div>
          </div>
        )}
      </nav>
      ...
      >
        <div id="main-content" className="absolute top-0 left-0" tabIndex={-1} />
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-wrestling-silver">
                      {siteContent.contact.name} - <a href={`mailto:${siteContent.contact.email}`} className="text-wrestling-red hover:underline transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-wrestling-red rounded">{siteContent.contact.email}</a>
                    </p>
                  </div>
                </div>
              </div>
