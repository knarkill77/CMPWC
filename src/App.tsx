                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-wrestling-silver">
                      {siteContent.contact.name} - <a href={`mailto:${siteContent.contact.email}`} className="text-wrestling-red hover:underline transition-colors">{siteContent.contact.email}</a>
                    </p>
                  </div>
                </div>
              </div>
