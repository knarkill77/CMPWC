...
function App() {
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans">
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-[100] focus:bg-white focus:text-black focus:p-4 focus:outline-none focus:ring-2 focus:ring-wrestling-red"
      >
        Skip to content
      </a>
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="md:hidden">
              <button
                ...
                className="p-2 focus:outline-none focus:ring-2 focus:ring-wrestling-red"
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-wrestling-silver">
                      ...
                      <a href={`mailto:${siteContent.contact.email}`} className="hover:text-wrestling-red transition underline-offset-4 hover:underline">
