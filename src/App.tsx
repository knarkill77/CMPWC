          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-8">
                <a href="#home" className="hover:text-wrestling-red px-3 py-2 text-sm font-medium uppercase transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-wrestling-red rounded-sm">Home</a>
                <a href="#teams" className="hover:text-wrestling-red px-3 py-2 text-sm font-medium uppercase transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-wrestling-red rounded-sm">Teams</a>
                <a href="#schedule" className="hover:text-wrestling-red px-3 py-2 text-sm font-medium uppercase transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-wrestling-red rounded-sm">Schedule</a>
                <a href="#details" className="hover:text-wrestling-red px-3 py-2 text-sm font-medium uppercase transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-wrestling-red rounded-sm">Details</a>
              </div>
            </div>
            ...
            <div className="md:hidden">
              <button
                ...
                className="p-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-wrestling-red rounded-sm"
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-black border-b border-white/10">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              <a href="#home" onClick={() => setIsMenuOpen(false)} className="block px-3 py-2 text-base font-medium uppercase focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-wrestling-red rounded-sm">Home</a>
              <a href="#teams" onClick={() => setIsMenuOpen(false)} className="block px-3 py-2 text-base font-medium uppercase focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-wrestling-red rounded-sm">Teams</a>
              <a href="#schedule" onClick={() => setIsMenuOpen(false)} className="block px-3 py-2 text-base font-medium uppercase focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-wrestling-red rounded-sm">Schedule</a>
              <a href="#details" onClick={() => setIsMenuOpen(false)} className="block px-3 py-2 text-base font-medium uppercase focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-wrestling-red rounded-sm">Details</a>
            </div>
          </div>
        )}
      </nav>
      ...
      <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden pt-16">
        <div className="absolute inset-0 z-0">
          ...
          <div className="w-full h-full bg-wrestling-grey opacity-20 flex items-center justify-center">
             <Trophy size={400} className="text-white/5 rotate-12" />
          </div>
        </div>
        ...
        <div className="relative z-20 text-center px-4 max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="#details" className="bg-wrestling-red hover:bg-red-700 text-white font-bold py-4 px-8 rounded-none transition flex items-center justify-center gap-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-wrestling-red focus-visible:ring-offset-2 focus-visible:ring-offset-black">
              EVENT DETAILS <ChevronRight size={20} />
            </a>
            <a href="#teams" className="border border-white/20 hover:bg-white/10 text-white font-bold py-4 px-8 rounded-none transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-wrestling-red">
              VIEW TEAMS
            </a>
          </div>
        </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex gap-4">
                  <MapPin className="text-wrestling-red flex-shrink-0" />
                  <div>
                    <p className="font-bold">{siteContent.event.venue.name}</p>
                ...
                <div className="flex gap-4">
                  <Mail className="text-wrestling-red flex-shrink-0" />
                  <div>
                    <p className="font-bold">Contact Organizer</p>
                    <p className="text-wrestling-silver">
                      {siteContent.contact.name} - <a href={`mailto:${siteContent.contact.email}`} className="hover:text-wrestling-red transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-wrestling-red rounded-sm">{siteContent.contact.email}</a>
                    </p>
                  </div>
                </div>
              </div>
      ...
      <footer className="bg-black border-t border-white/10 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex justify-center space-x-6 text-wrestling-silver">
            <a href="#" className="hover:text-white transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-wrestling-red rounded-sm">Instagram</a>
            <a href="#" className="hover:text-white transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-wrestling-red rounded-sm">Facebook</a>
            <a href="#" className="hover:text-white transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-wrestling-red rounded-sm">Twitter</a>
          </div>
        </div>
      </footer>
    </div>
