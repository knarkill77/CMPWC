...
function App() {
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans">
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-[60] focus:bg-wrestling-red focus:text-white focus:px-4 focus:py-2 focus:font-bold"
      >
        Skip to content
      </a>
      {/* Navigation */}
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-8">
                <a href="#home" className="hover:text-wrestling-red focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-wrestling-red px-3 py-2 text-sm font-medium uppercase transition">Home</a>
                <a href="#teams" className="hover:text-wrestling-red focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-wrestling-red px-3 py-2 text-sm font-medium uppercase transition">Teams</a>
                <a href="#schedule" className="hover:text-wrestling-red focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-wrestling-red px-3 py-2 text-sm font-medium uppercase transition">Schedule</a>
                <a href="#details" className="hover:text-wrestling-red focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-wrestling-red px-3 py-2 text-sm font-medium uppercase transition">Details</a>
              </div>
            </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-black border-b border-white/10">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              <a href="#home" onClick={() => setIsMenuOpen(false)} className="block px-3 py-2 text-base font-medium uppercase focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-wrestling-red">Home</a>
              <a href="#teams" onClick={() => setIsMenuOpen(false)} className="block px-3 py-2 text-base font-medium uppercase focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-wrestling-red">Teams</a>
              <a href="#schedule" onClick={() => setIsMenuOpen(false)} className="block px-3 py-2 text-base font-medium uppercase focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-wrestling-red">Schedule</a>
              <a href="#details" onClick={() => setIsMenuOpen(false)} className="block px-3 py-2 text-base font-medium uppercase focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-wrestling-red">Details</a>
            </div>
          </div>
        )}
      </nav>
      ...
      <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden pt-16">
        <div id="main-content" className="absolute top-0 left-0" />
        ...
        <div className="relative z-20 text-center px-4 max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="#details" className="bg-wrestling-red hover:bg-red-700 text-white font-bold py-4 px-8 rounded-none transition flex items-center justify-center gap-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white">
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-wrestling-silver">{siteContent.contact.name} - {siteContent.contact.email}</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <footer className="bg-black border-t border-white/10 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex justify-center space-x-6 text-wrestling-silver">
            <a href="#" className="hover:text-white transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-wrestling-red">Instagram</a>
            <a href="#" className="hover:text-white transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-wrestling-red">Facebook</a>
            <a href="#" className="hover:text-white transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-wrestling-red">Twitter</a>
          </div>
        </div>
      </footer>
    </div>
