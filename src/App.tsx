...
function App() {
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans">
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:absolute focus:z-[100] focus:bg-white focus:text-black focus:p-4"
      >
        Skip to content
      </a>
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-8">
                <a href="#main-content" className="hover:text-wrestling-red px-3 py-2 text-sm font-medium uppercase transition">Home</a>
        ...
        {isMenuOpen && (
          <div id="mobile-menu" className="md:hidden bg-black border-b border-white/10">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              <a href="#main-content" onClick={() => setIsMenuOpen(false)} className="block px-3 py-2 text-base font-medium uppercase">Home</a>
      ...
      {/* Hero Section */}
      <section id="main-content" className="relative h-screen flex items-center justify-center overflow-hidden pt-16">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-wrestling-silver">
                      {siteContent.contact.name} -{' '}
                      <a
                        href={`mailto:${siteContent.contact.email}`}
                        className="hover:text-wrestling-red transition underline-offset-4 hover:underline"
                      >
