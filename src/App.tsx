                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-wrestling-silver">
                      {siteContent.contact.name} - <a href={`mailto:${siteContent.contact.email}`} className="hover:text-wrestling-red transition underline-offset-4 hover:underline">{siteContent.contact.email}</a>
                    </p>
                  </div>
                </div>
              </div>
