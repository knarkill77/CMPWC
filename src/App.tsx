  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans">
      ...
      <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden pt-16">
        <div id="main-content" className="absolute top-0 left-0 w-0 h-0" />
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-wrestling-silver">
                      {siteContent.contact.name} - <a href={`mailto:${siteContent.contact.email}`} className="text-wrestling-red hover:underline focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-wrestling-red">{siteContent.contact.email}</a>
                    </p>
                  </div>
                </div>
              </div>
